...
class Tetris():
    FIELD_HEIGHT = 20 # высота
    FIELD_WIDTH = 10 #шерина
    ...
    def reset_tetromino(self):
        self.tetromino = random.choice(Tetris.TETROMINOS)[:] #отвечает за выбор фигуры
        self.tetromino_color = random.randint(1, len(COLORS) - 1) # отвечает за цвет
